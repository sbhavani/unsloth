...
# Apply FP8 autocast wrapper for FP8 compute during forward/backward
print("\n[3.6/4] Applying FP8 autocast wrapper...")
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        fp16=False,
        bf16=True,  # IMPORTANT: FP8 works WITH BF16 autocast, not instead of it!
        logging_steps=10,
