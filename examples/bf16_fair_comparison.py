#!/usr/bin/env python3
"""
BF16 Training - Fair comparison with FP8 (same batch, same loop)
"""
import os
...
# Patch for gradient checkpointing (same issue as FP8)
...
def patched_gc_call(self, *args, **kwargs):
    ...
    return _original_gc_call(self, *args, **kwargs)
GradientCheckpointingLayer.__call__ = patched_gc_call

print("=" * 80)
print("BF16 Training - Fair Comparison (batch=8, same loop)")
print("=" * 80)
...
print("=" * 80)
print("BF16 Training (batch=8, seq=512)")
print("=" * 80)
