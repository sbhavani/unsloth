#!/usr/bin/env python3
"""
BF16 Full Fine-tuning with SFTTrainer - Standard Configuration
Uses typical SFTTrainer settings that users would normally use.
Matches FP8 script for fair comparison (no gradient checkpointing, manual param unfreeze).
"""
import os
...
print("=" * 80)
print("BF16 Full Fine-tuning + SFTTrainer - STANDARD CONFIG (Llama-3.1-8B)")
print("=" * 80)
...
trainer = SFTTrainer(
    ...
    args=SFTConfig(
        ...
        # Matching FP8: No gradient checkpointing
...
print("\n" + "=" * 80)
print("BF16 Full Fine-tuning Complete! (Standard Config)")
print("=" * 80)
