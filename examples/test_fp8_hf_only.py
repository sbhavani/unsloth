#!/usr/bin/env python3
"""
Test FP8 with standard HuggingFace model (NO Unsloth patching).
This isolates whether Unsloth patching is the issue.
"""
import os
...
import time
print("=" * 80)
print("FP8 Test - Standard HuggingFace Model (NO Unsloth)")
print("=" * 80)
...
print("\n[1] Loading HuggingFace model (NO Unsloth)...")
...
# Results
print("\n" + "=" * 80)
print("RESULTS (Standard HuggingFace - NO Unsloth)")
print("=" * 80)
...
if speedup > 1.1:
    print("\n✅ FP8 IS faster on standard HuggingFace model!")
    print("   Conclusion: Unsloth's model patching is incompatible with FP8")
elif speedup < 0.9:
    print("\n⚠️  FP8 is SLOWER even without Unsloth")
    print("   The 1B model might be too small for FP8 benefits")
else:
