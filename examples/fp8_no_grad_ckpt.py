#!/usr/bin/env python3
"""
FP8 Full Fine-tuning WITHOUT gradient checkpointing
Fair comparison with BF16 full fine-tuning
"""
import os
...
print("=" * 80)
print("FP8 Full Fine-tuning (batch=8, seq=512, NO grad ckpt)")
print("=" * 80)
...
# Training
print("\n" + "=" * 80)
print("Starting FP8 Training (batch=8, seq=512, NO grad ckpt)")
print("=" * 80)
