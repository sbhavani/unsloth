...
print("=" * 80)
print("FP8 Full Fine-tuning + SFTTrainer (Llama-3.2-3B) - L40")
print("=" * 80)
...
print("- Manual param unfreezing (full_finetuning=True conflicts with FP8)")
print("- No gradient checkpointing (cuBLAS issues on L40)")
print("=" * 80)
